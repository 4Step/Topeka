Macro "Batch Macro"
    RunMacro("TCB Init")
ProjectPath="c:\\Topeka\\Original Model\\"
//---------------------------------------------------TRIP GENERATION-----------------------------------------------------------
// STEP 1: QRM All
     Opts = null
     Opts.Input.[Zone View] = {ProjectPath+"\\2034 Topeka Network.DBD|Endpoints", "Endpoints"}
     Opts.Input.[Zone Set] = {ProjectPath+"\\2034 Topeka Network.DBD|Endpoints", "Endpoints", "Selection", "Select * where ZONE>0"}
     Opts.Input.[Production Table] = {ProjectPath+"\\prod_tgp.dbf"}
     Opts.Input.[Attraction Table] = {ProjectPath+"\\attr_tgp.dbf"}
     Opts.Field.[Total HH] = "Endpoints.HH"
     Opts.Field.Dwelling = "Endpoints.HH"
...
// STEP 1: Build Highway Network
     Opts = null
     Opts.Input.[Link Set] = {ProjectPath+"\\2034 Topeka Network.DBD|Highways/Streets", "Highways/Streets"}
...
// STEP 2: Highway Network Setting
     Opts = null
     Opts.Input.Database = ProjectPath+"\\2034 Topeka Network.DBD"
     Opts.Input.Network = ProjectPath+"\\2034_Network.net"
     Opts.Input.[Centroids Set] = {ProjectPath+"\\2034 Topeka Network.DBD|Endpoints", "Endpoints", "Selection", "Select * where ZONE>0"}
...
// STEP 1: TCSPMAT
     Opts = null
     Opts.Input.Network = ProjectPath+"\\2034_NETWORK.NET"
     Opts.Input.[Origin Set] = {ProjectPath+"\\2034 Topeka Network.DBD|Endpoints", "Endpoints", "Selection", "Select * where ZONE>0"}
     Opts.Input.[Destination Set] = {ProjectPath+"\\2034 Topeka Network.DBD|Endpoints", "Endpoints", "Selection"}
     Opts.Input.[Via Set] = {ProjectPath+"\\2034 Topeka Network.DBD|Endpoints", "Endpoints"}
...
// STEP 1: Gravity
     Opts = null
     Opts.Input.[PA View Set] = {{ProjectPath+"\\2034 Topeka Network.dbd|Endpoints", ProjectPath+"\\QRM_ALL.bin", "ID", "ID1"}, "Endpoints+QRM_ALL", "Selection", "Select * where zone>0"}
...
// STEP 3: Fill Dataview
     Opts = null
     Opts.Input.[Dataview Set] = {{ProjectPath+"\\2034 Topeka Network.dbd|Highways/Streets", ProjectPath+"\\ASN_LinkFlow.bin", "ID", "ID1"}, "Highways/Streets+ASN_LinkFlow"}
