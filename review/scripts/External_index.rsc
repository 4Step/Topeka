...
// STEP 1: Add Matrix Index
     Opts = null
     Opts.Input.[Current Matrix] = "C:\\projects\\git_versions\\Topeka\\review\\Base\\SPMAT.mtx"
     Opts.Input.[Index Type] = "Both"
     Opts.Input.[View Set] = {"C:\\projects\\git_versions\\Topeka\\review\\Base\\Topeka Network.DBD|Endpoints", "Endpoints", "External Stations", "Select * where [Node Type] = 'External Station'"}
